...
def add_document_to_db(text, document_name, chat_id=None, organization_id=None, is_guest=False):
    if is_guest:
...
def add_message_to_db(text, chat_id, isUser, is_guest=False, reasoning=None):
