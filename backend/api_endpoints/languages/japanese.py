...
\"\"\""""
        ...
        full_messages = [
            {
                "role": "system",
                "content": "You are a chatbot assistant meant to speak to the user in japanese. You should help to user to answer on any questions in japanese. Respond in japanese no matter the language of the user. Be helpful and do not make up or hallucinate, if you do not know an answer, say you do not know."
            }
        ] + messages
