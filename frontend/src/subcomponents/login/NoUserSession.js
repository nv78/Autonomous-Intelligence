  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-[#141414]">
      <div className="flex-grow">
        ...
        <Button
          className="mx-auto mb-4 btn-yellow text-black"
          variant="primary"
        ...
        >
          ...
          <Modal.Body
            className="p-4 flex items-center justify-center bg-[#141414]
"
          >
            <div
              style={{
            ...
            >
              <a
                ...
                href="https://clipchamp.com/watch/UoPz2Tjbykg?utm_source=embed&utm_medium=embed&utm_campaign=watch"
              >
                <img
                  loading="lazy"
                  style={{ height: "30px" }}
